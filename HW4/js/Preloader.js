...
GameStates.makePreloader = function( game ) {
    ...
    return {
		...
		preload: function () {
			...
			game.load.atlasJSONHash('Victory', 'assets/victorypose2.png', 'assets/victorypose2.json');
			//	+ lots of other required assets here
	        game.load.audio('music', ['assets/happytune.mp3', 'assets/happytune.ogg']);
	        game.load.audio('paper', ['assets/page-turn.mp3', 'assets/page-turn.ogg']);
	        ...
	        game.load.spritesheet('mailbox', 'assets/mailbox.png', 64, 64);
